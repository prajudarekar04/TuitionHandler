...
public class SearchStudentRollNo  extends JDialog implements ActionListener
{
    JButton print,bck;
    ...
    public SearchStudentRollNo(JFrame parent,String title,boolean state,DB ref,int rollno)
    {
        super(parent,"Search Student Name",state);
        this.ref=ref;

        this.rollno=rollno;
       
        head = new JLabel("Student Display");
